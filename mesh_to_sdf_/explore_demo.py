import numpy as np
from mesh_to_sdf.mesh_to_sdf import get_surface_point_cloud, scale_to_unit_sphere, sample_sdf_near_surface
import trimesh
...
def sdf_process(input_name, output_name):
...
if __name__ == "__main__":
    ...
    for name in name_list:
        ...
        result_path = os.path.join(r"D:\XiaohanYuan\SDF\examples\cardiac\Reconstructions\1070\Meshes\cardiac\2", name+".ply")
        gt_path = os.path.join(r"\\SEUVCL-DATA-01\Medical\[PRO]SDF\obj_pca\2", name+".obj")
    ...
    # sdf_process(r'D:\XiaohanYuan\SDF\mesh_to_sdf\example\0000template_1836083_040_LV.obj', "heart.npz")
    #
