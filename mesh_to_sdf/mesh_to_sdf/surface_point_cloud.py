...
class SurfacePointCloud:
    ...
    def sample_sdf_near_surface(self, number_of_points=500000,sampling_type="sphere", use_scans=True, sign_method='normal', normal_sample_count=11, min_size=0, return_gradients=False):
        query_points = []
        ...
        unit_sphere_points = sample_uniform_points_in_unit_sphere(unit_sphere_sample_count,sampling_type)
