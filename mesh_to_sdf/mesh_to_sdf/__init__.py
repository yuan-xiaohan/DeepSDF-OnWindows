...
def sample_sdf_near_surface(mesh, number_of_points = 500000,sampling_type="sphere", surface_point_method='scan', sign_method='normal', scan_count=100, scan_resolution=400, sample_point_count=10000000, normal_sample_count=11, min_size=0, return_gradients=False):
    ...
    return surface_point_cloud.sample_sdf_near_surface(number_of_points, sampling_type, surface_point_method=='scan', sign_method, normal_sample_count, min_size, return_gradients)
